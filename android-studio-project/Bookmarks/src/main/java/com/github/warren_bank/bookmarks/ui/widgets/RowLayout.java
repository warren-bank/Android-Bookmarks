...
// -----------------------------------------------------------------------------
// https://stackoverflow.com/a/4937713
// -----------------------------------------------------------------------------
...
public class RowLayout extends ViewGroup {
  ...
  public RowLayout(Context context, AttributeSet attrs) {
    ...
    horizontalSpacing = styledAttributes.getDimensionPixelSize(R.styleable.RowLayout_horizontalSpacing, DEFAULT_HORIZONTAL_SPACING);
    verticalSpacing   = styledAttributes.getDimensionPixelSize(R.styleable.RowLayout_verticalSpacing,   DEFAULT_VERTICAL_SPACING);
